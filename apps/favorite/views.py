...
from .serializers import FavoriteSerializer, FavoriteAddSerializer
...
class FavoriteList(generics.ListAPIView):
    ...
    #     self.queryset = Favorite.objects.order_by('-created_at').filter(user=request.login_user)
...
class FavoriteDelete(CustomLoginRequiredMixin, generics.DestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        cart = Favorite.objects.get(pk=self.kwargs['pk'])
